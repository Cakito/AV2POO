					...
					.addGroup(gl_inputPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_inputPane.createSequentialGroup()
							...
							.addGroup(gl_inputPane.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(passwordField_1, GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)))
						.addGroup(gl_inputPane.createSequentialGroup()
							.addGap(32)
	...
	public void show_user() {
			...
			try {
				...
				for(Funcionario funcionario:controller.read()) {
					modelo.addRow(new Object[] {funcionario.getId(), funcionario.getNome()/*, funcionario.getSenha()*/});
				}
			}catch(Exception e) {
				e.printStackTrace();
			}
